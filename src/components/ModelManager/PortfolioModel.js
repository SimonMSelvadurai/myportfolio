...
const PortfolioModel = ({Payload,hideDetailItem}) => {
    const {image,name,des,github,live} = Payload;
    const hideDetails = () => {
                        ...
                        <div className="container">
                            <div className="row justify-content-center">
                                <div className="col-lg-8">
                                    ...
                                    <a className="btn btn-primary btn-social mx-1" href={github} target="_blank" rel="noopener noreferrer">
                                <i className="fab fa-github"></i>
                            </a>
                            <a className="btn btn-primary btn-social mx-1" href={live} target="_blank" rel="noopener noreferrer">
